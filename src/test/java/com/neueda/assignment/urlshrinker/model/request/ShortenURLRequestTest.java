...
class ShortenURLRequestTest extends BeanValidationTest<ShortenURLRequest> {
    ...
    void shortenURLRequest_withNullUrlAddress_failsToValidate() {
    ...
    void shortenURLRequest_withBlackURLAddress_failsToValidate() {
        ShortenURLRequest request = new ShortenURLRequest("");
        verifyViolationForFieldWithMessage("urlAddress", "must not be blank", request);
    }
    ...
    void shortenURLRequest_withNonURLAddress_failsToValidate() {
    ...
    void shortenURLRequest_withURLAddressLongerThan2000Characters_failsToValidate() {
    ...
    void shortenURLRequest_withValidURLAddress_succeedsToValidate() {
